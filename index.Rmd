...
```{r}
confirmados.order <- order(ca_covid19$confirmados, decreasing=TRUE)
ca_covid19.confirmados <- ca_covid19[confirmados.order,]
```
...
```{r}
barplot(height = ca_covid19.confirmados$confirmados,names.arg = ca_covid19.confirmados$pais,xlab = "País", ylab = "Casos confirmados", main = "Casos confirmados de Covid-19 en paises de Centroamerica y República Dominicana")
```
...
```{r}
activos.order <- order(ca_covid19$activos, decreasing = TRUE)
ca_covid19.activos <- ca_covid19[activos.order,]
barplot(height = ca_covid19.activos$activos, names.arg = ca_covid19.activos$pais,xlab = "País",ylab = "Casos activos", main = "Casos activos de Covid-19 en paises de Centroamerica y República Dominicana")
```

```{r}
fallecidos.order <- order(ca_covid19$fallecidos, decreasing = TRUE)
ca_covid19.fallecidos <- ca_covid19[fallecidos.order,]
barplot(height = ca_covid19.fallecidos$fallecidos,names.arg = ca_covid19.fallecidos$pais,xlab = "País",ylab = "Casos Fallecidos", main = "Casos Fallecidos de Covid-19 en paises de Centroamerica y República Dominicana")
```
